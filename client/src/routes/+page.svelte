...
<Phone>
	<div class="flex h-full w-full flex-col">
		...
		<main> 
			...
			<button class="btn btn-neutral w-full mt-5">Accedi</button>
		</main>
	</div>
</Phone>
	...
	<div class="flex h-full w-full flex-col">
		<header>
			<div class="navbar bg-base-100 space-x-2">
				<div class="my-8 flex flex-1 flex-row gap-2">
					<div class="avatar">
